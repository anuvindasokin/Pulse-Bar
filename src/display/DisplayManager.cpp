...
void DisplayManager::metricIcon(bool views,CRGB color){static const uint8_t eye[3]={0b01110,0b10101,0b01110};static const uint8_t person[7]={0b01110,0b11111,0b11111,0b01110,0b00100,0b01110,0b11111};const uint8_t* rows=views?eye:person;int height=views?3:7,x0=views?0:27,y0=views?2:0;for(int y=0;y<height;y++)for(int x=0;x<5;x++)if(rows[y]&(1<<(4-x)))pixel(x0+x,y0+y,color);}
